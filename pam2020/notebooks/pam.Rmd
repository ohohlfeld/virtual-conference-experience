...
# All responses
* [All responses](pam_all_responses.md): 31 reponses pre-conf, 28 post-conf
...
* [Industry](pam_industry.md): ("Industry" and "government scientist")
  * 9 responses pre-conf, 6 post-conf --- a bit too few to draw solid conclusions
* [Faculty](pam_faculty.md): ("Faculty" and "Postdoc")
  * 9 responses pre-conf, 9 post-conf --- 
* [Students](pam_students.md): ("PhD student" and "Master student" / undergrad)
...
* [Responses by users with no prior remote conference experience](pam_no_prior_remote_experience.md)
  * 25 responses pre-conf, 24 post-conf --- solid
* [Responses by users with prior remote conference experience](pam_prior_remote_experience.md)
